...
abstract public class ModbusValue {
	...
	public boolean booleanValue() {
		...
		throw new InvalidDataConversionException("Impossible de convertir "
				+ value.getClass() + " en boolean");
	}
	...
	public BigInteger bigIntegerValue() {
		...
		if (value instanceof Integer)
			return BigInteger
					.valueOf(((Integer) value).intValue() & 0xffffffff);
		if (value instanceof Short)
			return BigInteger.valueOf(((Short) value).shortValue() & 0xffff);
		throw new InvalidDataConversionException("Impossible de convertir "
				+ value.getClass() + " en type BigInteger");
	}
