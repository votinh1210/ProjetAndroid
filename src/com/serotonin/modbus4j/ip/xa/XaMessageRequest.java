...
public class XaMessageRequest extends XaMessage implements
		OutgoingRequestMessage, IncomingRequestMessage {
	static XaMessageRequest createXaMessageRequest(ByteQueue queue)
		...
		if (protocolId != ModbusUtils.IP_PROTOCOL_ID)
			throw new ModbusTransportException(
					"Id de protocole IP non pris en charge : " + protocolId);
